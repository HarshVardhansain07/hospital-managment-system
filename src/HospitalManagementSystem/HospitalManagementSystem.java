...
public class HospitalManagementSystem {
    ...
    private static final String password = "harshME@855";
    ...
    public static void bookAppointment(Patients patient, Doctor doctor, Connection connection, Scanner scanner){
        ...
        if(patient.getPatientById(patientId) && doctor.getDoctorById(doctors_id)){
            if(checkDoctorAvailability(doctors_id, appointmentDate, connection)){
    ...
    public static boolean checkDoctorAvailability(int doctors_id, String appointmentDate, Connection connection){
